...
function EBX_AJAXResponseHandler() {
	...
	this.handleAjaxResponseSuccess = function(responseContent) {
		EBXLogger.log("Ajax object must implement method [ handleAjaxResponseSuccess(responseContent) ]", EBXLogger.error);
	};
	...
	this.handleAjaxResponseFailed = function(responseContent) {
		EBXLogger.log("Ajax object must implement method [ handleAjaxResponseFailed(responseContent) ]", EBXLogger.error);
	};
}
