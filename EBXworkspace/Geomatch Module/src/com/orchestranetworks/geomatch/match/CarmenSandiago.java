...
import com.orchestranetworks.geomatch.Paths;
...
public class CarmenSandiago extends ScriptTaskBean {
	...
	public void executeScript(ScriptTaskBeanContext context) throws OperationException {
		...
		//the actual geomatch stuff
		//ragequit
		AdaptationTable at = (a.createValueContext().getAdaptationTable());
		...
		//loops through all records returned, matches to them, makes em false! 
